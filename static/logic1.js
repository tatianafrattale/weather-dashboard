...
//   let selected_city = seven_day_data.filter(c => c.name === chosen_city);
...
//   for (var i = 0; i < selected_city.list.length; i++){
//     seven_day_temp.max.append(selected_city.list[i].max)
//     seven_day_temp.min.append(selected_city.list[i].min)
//   }
 ...
 // d3.json("current_weather_data.txt").then(function(response) {
  ...
  myMap = L.map("map", {
   ...
   layers: [
    ...
    console.log("seven day data");
    seven_day_data = d3.json("/seven-day-data-json");
    console.log(seven_day_data);
